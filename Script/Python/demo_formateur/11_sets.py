...
print({1, 2, 3, 99}.issubset({1, 2, 3, 4, 5, 6})) #False

# Pour tester si un set comprend un autre set
print({1, 2, 3, 4, 5, 6}.issuperset({1, 2, 3})) #True
print({1, 2, 3, 4, 5, 6}.issuperset({1, 2, 3, 99})) #False



mon_set_a = {1, 2, 3, 4, 5, 6}
mon_set_b = {5, 6, 7, 8, 9, 10}
print(mon_set_a.union(mon_set_b))  # UNION != update, ici il retourne l'union sans modifier mon_set_a
